    ...
    <section class="homepage-about spad section">
        <div class="container">
            <div class="row">
                <form class="form-horizontal" action="<?php echo site_url($this->router->class . '/listar/' . $this->uri->segment(3));?>" method="GET">
                    ...
                    <div class="btn-grid">
                        ...
                        <div class="col-lg-3 col-xs-3">
                            ...
                            <?php } ?>
                            <a href="<?php echo site_url('/rifas/consultar/' . $this->uri->segment(3));?>" class="btn btn-primary sm-padding">Sorteio</a>
                        </div>
                    </div>
